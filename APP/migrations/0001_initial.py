    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('sold', 'sold'), ('availble', 'availble'), ('rental', 'rental')], max_length=50, null=True)),
                ('catrgory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='APP.category')),
            ],
        ),
    ]
